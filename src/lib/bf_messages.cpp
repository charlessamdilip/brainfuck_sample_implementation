...
void Messages::display_welcome_message() {
  ...
  cout << "view a or view a b, prints the memoryspace as ascii" << endl;
  cout << "view a or view a b, prints the memoryspace as integer" << endl;
...
void Messages::out_of_bounds(bool less) {
  cout << "Array index out of bounds "<< (less ? -1 : 1000) << endl << endl;
}
